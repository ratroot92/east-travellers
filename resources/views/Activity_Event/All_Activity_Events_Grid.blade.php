...
function getCityNameForSearch(city) {
    console.log(city);
    window.location.href = "{{URL::to('search/activity/grid/city')}}" + "/" + city;
}

function getCountryNameForSearch(country) {
    console.log(country);
    window.location.href = "{{URL::to('search/activity/grid/country')}}" + "/" + country;
}

function getCategoryNameForSearch(category) {
    console.log(category);
    window.location.href = "{{URL::to('search/activity/grid/category')}}" + "/" + category;
}
...
function getPriceForSearch(price) {
    ...
    window.location.href = "{{URL::to('search/activity/grid/price')}}" + "/" + min + "/" + max;
}
