            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" href="#cruises">Cruises</a></li>
                        <li><a data-toggle="tab" href="#transfers">Transfers</a></li>
                        <li><a data-toggle="tab" href="#daytours">Daytours</a></li>
                        <li><a data-toggle="tab" href="#pacakges">Packages</a></li>
...
font-weight: 700;">Event Type : {{$item->event_type}}</h4>
                                        ...
                                        <div class="col-md-3">
                                            <div class="hot-page2-alp-ri-p3 tour-alp-ri-p3">
                                                @if($item->discount !=0)
                                                <div class="hot-page2-alp-r-hot-page-rat pull">{{$item->discount}} % Off
                                                </div>
                                                @else
                                        ...
                                        <div>
                                            <div class="trav-ami">
                                                ...
                                                <ul>
                                                    ...
                                                    <li href="{{  url('event_detail/')}}/{{ $item->id }}"><img
                                                            src="{{$Icon->description}}" alt="">
