...
<section>
    <div class="rows inner_banner inner_banner_5">
        <div class="container">
            ...
            <p>Book travel package and enjoy your holidays with distinctive experience</p>
        </div>
    </div>
</section>
...
<div class="container">
    <div class="row">
                            ...
                            <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
                                <form>
                                    <div id="cities">
                                        <ul class="">
                                            <li>
                                                <a href="{{route('all.events.package')}}" style="padding:0px!important;margin:0px!important;color:white; border:none;">
        ...
        <div class="col-md-9 " id="searchRendering">
            ...
            <div class="row">
                <div class="col-md-12 alert alert-success">
                    <p class="text-dark font-weight-bold">Showing All Package Events </p>
                </div>
            </div>
            @endif
            @foreach($All_Package_Events as $key=>$item)
...
<script>
    function getCityNameForSearch(city) {
        console.log(city);
        window.location.href = "{{URL::to('search/package/city')}}" + "/" + city;
    }

    function getCountryNameForSearch(country) {
        console.log(country);
        window.location.href = "{{URL::to('search/package/country')}}" + "/" + country;
    }

    function getCategoryNameForSearch(category) {
        console.log(category);
        window.location.href = "{{URL::to('search/package/category')}}" + "/" + category;
    }
    ...
    function getPriceForSearch(price) {
        ...
        window.location.href = "{{URL::to('search/package/price')}}" + "/" + min + "/" + max;
    }
    ...
    $(document).ready(function() {
        $('#DisplayStyle').on('click', function() {
            ...
            if ($('#DisplayStyle').prop("checked") == false || $('#DisplayStyle').prop("checked") ==
                'false') {
                window.location.href = "{{URL::to('all/events/package/grid')}}";
            } else {
                window.location.href = "{{URL::to('all/events/package')}}";
            }
        })
    })
</script>