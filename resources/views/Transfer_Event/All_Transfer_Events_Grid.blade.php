...
function getCityNameForSearch(city) {
    console.log(city);
    window.location.href = "{{URL::to('search/transfer/grid/city')}}" + "/" + city;
}

function getCountryNameForSearch(country) {
    console.log(country);
    window.location.href = "{{URL::to('search/transfer/grid/country')}}" + "/" + country;
}

function getCategoryNameForSearch(category) {
    console.log(category);
    window.location.href = "{{URL::to('search/transfer/grid/category')}}" + "/" + category;
}
...
function getPriceForSearch(price) {
    ...
    window.location.href = "{{URL::to('search/transfer/grid/price')}}" + "/" + min + "/" + max;
}
