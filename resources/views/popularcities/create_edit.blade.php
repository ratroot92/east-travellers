                ...
                <form method="post" enctype="multipart/form-data" action="{{url("popularcities/$action/$id")}}">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="" type="text" name="name" class="validate"
                                value="@if(isset($popularcities_data[0]->name)) {{$popularcities_data[0]->name}} @endif">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="" type="text" name="country" class="validate"
                                value="@if(isset($popularcities_data[0]->country)) {{$popularcities_data[0]->country}} @endif">
                            ...
                            <div class="file-field">
                                ...
                                <div class="col-sm-3">
                                    <img class="img-thumbnail img-responsive"
                                        src="{{url(App\StoragePath::path().'/storage/popularcities/'.$popularcities_data[0]->banner)}}"
                                        alt="">
                                </div>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea id="textarea1" class="materialize-textarea"
                                name="description">@if(isset($popularcities_data[0]->description)){{$popularcities_data[0]->description}} @endif</textarea>
