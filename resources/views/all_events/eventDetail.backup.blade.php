                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#overviewTab">Overview</a></li>
                            <li><a data-toggle="tab" href="#photoTab">Photo</a></li>
                            <li><a data-toggle="tab" href="#Itnerary">Itnerary</a></li>
                            <li><a data-toggle="tab" href="#inclusionTab">Inclusion</a></li>
                            <li><a data-toggle="tab" href="#tcTab">T&C</a></li>
                            <li><a data-toggle="tab" href="#policyTab">Policy</a></li>
                            <li><a data-toggle="tab" href="#visaTab">Visa</a></li>
                            <li><a data-toggle="tab" href="#notesTab">Notes</a></li>
                            <li><a data-toggle="tab" href="#faqTab">FAQ</a></li>
                          ...
                          <div class="tab-content">
                            ...
                            <div id="photoTab" class="tab-pane fade">
                              <h3>photoTab 1</h3>
                                ...
                                <!--====== ITNERARY  TAB   ==========-->
                            <div id="Itnerary" class="tab-pane fade">
                              <h3>Itnerary 2</h3>

                            </div>
                            <!--====== ITNERARY  TAB   ==========-->
                            <!--====== INCLUSION  TAB   ==========-->
                            <div id="inclusionTab" class="tab-pane fade">
                              ...
                              <!--====== TCTAB  TAB   ==========-->
                            <div id="tcTab" class="tab-pane fade">
                                <h3>TC 2</h3>
                              ...
                              <!--====== POLICY TAB     ==========-->
                            <div id="policyTab" class="tab-pane fade">
                                <h3>POLICY TAB     2</h3>
                              ...
                              <!--====== VISA TAB     ==========-->
                            <div id="visaTab" class="tab-pane fade">
                                <h3>VISA TAB     2</h3>
