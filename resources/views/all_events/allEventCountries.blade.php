            ...
            <table class="table">
                ...
                @foreach($Event_Country as $key=>$item)
                    ...
                    --}}
                        ...
                        <td><a  href="{{route('view.update.eventcountry',['action'=>'update','id'=>$item->id])}}" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                        </td>
                        <td>
                            <i  href="{{  url('delete/event_country') }}/{{ $item->id }}" onclick="confirm_delete('{{$item->id}}')" class="sb2-2-1-edit"><i class="fa fa-trash-o" aria-hidden="true"></i></i>
                        </td>
                    </tr>
                @endforeach
                </tbody>
