        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @endif</td>
                    --}}
                    <td><img src="{{$item->description}}" alt="{{$item->description}}" class="img"
                            style="width: 75%;height: 150px"></td>
                    <td>
                        <!-- <div class="col-sm-12"> -->
                    ...
                    <td><a href="{{route('view.update.eventicon',['action'=>'update','id'=>$item->id])}}"
