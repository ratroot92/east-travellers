...
<div class="sb2-2">
    ...
    <div class="sb2-2-add-blog sb2-2-1">
                        ...
                        <div class="row">
                            <div class="input-field col s12 font-weight-bold">
                                <select multiple name="country[]" id="country" required>
                                    ...
                                    <!--  -->
                                    @foreach($country_list as $country)
                                    @if(!$Event->Event_Countries->isEmpty())
                                    @if ($selected = '') @endif
                                    @foreach($Event->Event_Countries as $countryy)
                        ...
                        <div class="row">
                            <div class="input-field col s12 font-weight-bold">
                                <select multiple name="city[]" id="city" required="required">
                                    ...
                                    <!--  -->
                                    @foreach($event__cities as $city)
                                    @if(!$Event->Event_Cities->isEmpty())
                                    @if ($selected = '') @endif
                                    @foreach($Event->Event_Cities as $cityy)
        ...
        <div class="row">
            <div class="input-field col s12 font-weight-bold">
                <select multiple name="cat[]" id="cat" required>
                    ...
                    <!--  -->
                    @foreach($packagecat as $category)
                    @if(!$Event->Event_Categories->isEmpty())
                    @if ($selected = '') @endif
                    @foreach($Event->Event_Categories as $cat)
        ...
        <div class="row">
            ...
            <div class="input-field col s12 font-weight-bold">
                <div class="file-field">
                    <div class="btn">
                        ...
                        <input type="file" name="file[]" id="file" accept=".xlsx,.xls,.doc, .docx,.ppt, .pptx,.txt,.pdf"
                            multiple="multiple" />
                    </div>
            ...
            @else
            <span class="alert-warning  pull-right ">only upload files * <span class="text-danger">Previous files will
            ...
            <div class="d-flex flex-row justify-content-center align-items-center ">
                ...
                <img src="{{str_replace('http://localhost:8000/public/','http://localhost:8000/',$image->src)}}" alt=""
                    class="img-fluid img-thumbnail " height="300" width="300">
                @endforeach
            </div>
            <div class="input-field col s12 font-weight-bold">
                <span class="alert-warning  pull-right ">only upload images * <span class="text-danger">Previous images
        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="input-field col s12 font-weight-bold">
                    ...
                    @else
                    <input type="text" class="validate" name="duration" id="duration" placeholder="5 Days"
                        value="{{$Event->duration ?? ''}}" required />
                    @endif
                    <span></span>
            ...
            <div class="row">
                <div class="input-field col s12 font-weight-bold">
                    ...
                    @else
                    <input type="text" name="disc" id="disc" class="validate" value="{{$Event->discount ?? ''}}"
                        required />
                    @endif
            ...
            <div class="row">
                <div class="input-field col s12 font-weight-bold">
                    ...
                    @else
                    <input id="" type="number" name="price" id="price" class="validate" value="{{$Event->price ?? ''}}"
                        required />
                    @endif
            ...
            <div class="row">
                <div class="input-field col s12 font-weight-bold">
                    @if($action=="addEvent")
                    <input type="text" name="grpsize" id="grpsize" class="validate" placeholder="Min:2 / Max:16" min="2"
                        max="16" name="grpsize" value="" required="required" />
                    @else
                    <input type="text" name="grpsize" id="grpsize" class="validate" placeholder="Min:2 / Max:16" min="2"
                        max="16" name="grpsize" required="required" value="{{$Event->group_size ?? ''}}" />
                    @endif
            ...
            <div class="row">
                <div class="input-field col s12 font-weight-bold">
                    @if($action=="addEvent")
                    <input type="text" class="validate" placeholder="Vienna  " id="startloc" name="startloc"
                        required="required" />
                    @else
                    <input type="text" class="validate" placeholder="Vienna  " id="startloc" name="startloc"
                        required="required" value="{{$Event->start_location ?? ''}}" />
                    @endif
            ...
            <div class="row">
                ...
                <div class="input-field col s12 font-weight-bold">
                    ...
                    @else
                    <input type="text" class="validate" id="tranportdetails" name="tranportdetails" required="required"
                        placeholder="Van" value="{{$Event->transport_details ?? ''}}" />
                    @endif
            ...
            <div class="row">
                ...
                <div class="input-field col s12 font-weight-bold">
                    ...
                    @else
                    <input type="text" class="validate" id="tourlanguage" name="tourlanguage" placeholder="English"
                        required="required" value="{{$Event->tour_language ?? ''}}" />
                    @endif
            ...
            <div class="row">
                ...
                <div class="input-field col s12 font-weight-bold">
                    ...
                    <input type="text" class="validate" id="accomodationdetails" name="accomodationdetails"
                        placeholder="Included / Not included " required="required"
                        value="{{$Event->accomodation_details ?? ''}}" />
                    @endif
            ...
            <div class="row">
                ...
                <div class="input-field col s12 font-weight-bold">
                    ...
                    @else
                    <input type="text" class="validate" id="guidedetails" name="guidedetails" required="required"
                        value="{{$Event->guide_details ?? ''}}" placeholder="Including English Speaker" />
                    @endif
            ...
            <div class="row">
                ...
                <div class="input-field col s12 font-weight-bold">
                    ...
                    @if($action=="addEvent")
                    <input type="text" class="validate" id="tourcode" name="tourcode" placeholder="Tour Code" value=""
                        required="required" />
                    @else
                    <input type="text" class="validate" id="tourcode" name="tourcode" placeholder="Tour Code"
                        value="{{$Event->tour_code ?? ''}}" required="required" />
                    @endif
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="input-field col s12 font-weight-bold">
                    ...
                    @if($action=="addEvent")
                    <input type="text" class="validate" id="tourstyle" name="tourstyle" placeholder="Tour Style"
                        value="" required="required" />
                    @else
                    <input type="text" class="validate" id="tourstyle" name="tourstyle" placeholder="Tour Style"
                        value="{{$Event->tour_style ?? '' }}" required="required" />
                    @endif
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="input-field col s12 font-weight-bold">
                    ...
                    @if($action=="addEvent")
                    <input type="text" class="validate" id="avalibilitydetails" name="avalibilitydetails"
                        placeholder="Availablity Details" value="" required="required" />
                    @else

                    <input type="text" class="validate" id="avalibilitydetails" name="avalibilitydetails"
                        placeholder="Availablity Details" value="{{$Event->avalibility_details ?? ''}}"
                        required="required" />
                    @endif
                </div>
            </div>
            ...
            <div class="row">
                <div class="input-field col s12 font-weight-bold">
                    ...
                    <textarea id="" class="materialize-textarea" name="code" id="code"
                        ...
                        /required> </textarea> @else <textarea id="" class="materialize-textarea" name="code" id="code"
                        placeholder='<iframe id="regiondo-booking-widget" data-width="338px" data-url="https://eastravels.regiondo.com/bookingwidget/vendor/23641/id/94437" data-title="Berlin in 7 Days" style="margin: 0px; padding: 0px; overflow: hidden; vertical-align: top; border: 0px; background: transparent; width: 338px; height: 455px;" data-processed="1" frameborder="0" src="https://eastravels.regiondo.com/bookingwidget/vendor/23641/id/94437?bookingwidget=1&amp;secure=1" data-id="1"></iframe>'
                        /required> {{$Event->code ?? ''}}</textarea> @endif <label for="textarea1">Code:</label>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="input-field col s12 font-weight-bold">
                    <select multiple name="icons[]" id="icons" required>
                        ...
                        @if(!$Event->Event_Icons->isEmpty())
                        @if ($selected = '') @endif
                        @foreach($Event->Event_Icons as $cat)
