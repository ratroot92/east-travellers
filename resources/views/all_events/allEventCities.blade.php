...
<div class="sb2-2">
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="active-bre"><a href="{{route('view.all.cities')}}"> <b>All Event Cities</b> </a></li>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" style="vertical-align:middle;"><a
                            href="{{route('view.update.eventcity',['action'=>'update','id'=>$item->id])}}"
                            class="sb2-2-1-edit"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a>
                    </td>
                    <td class="text-center" style="vertical-align:middle;">
                        <i href="{{  url('delete/event_city') }}/{{ $item->id }}"
