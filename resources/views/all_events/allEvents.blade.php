                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="vertical-align:middle;"> @foreach($item->Event_Categories as
                            ...
                            {{$cat->name}}<br>
                            @endforeach</td>
                        <td class="text-center" style="vertical-align:middle;"><img src="{{str_replace('http://localhost:8000/public/','http://localhost:8000/',$item->banner)}}" alt="{{$item->event_name}}" class="img" style="width: 100%;height: 120px"></td>
                        ...
                        <td class="text-center" style="vertical-align:middle;"><a href="{{ url('view_update_event/updateEvent')}}/{{$item->id}}" class="sb2-2-1-edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            <i onclick="confirm_delete('{{$item->id}}')" href="{{  url('delete_event') }}/{{ $item->id }}" class="sb2-2-1-edit"><i class="fa fa-trash-o fa-2x" aria-hidden="true"></i></i>
                            <a href="{{  url('event_detail') }}/{{ $item->id }}" target="_blank" class="sb2-2-1-edit"><i class="fa fa-eye" aria-hidden="true"></i></a>
                        </td>
