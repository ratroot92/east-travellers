...
<div class="sb2-2">
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="active-bre"><a href="{{route('view.add.category',['action'=>'add'])}}"> Add Event Category
                </a>
            </li>
            <li class="active-bre"><a href="{{route('view.all.categories')}}"> <b>All Event Categories</b> </a></li>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" style="vertical-align:middle;"><a
                            href="{{route('view.update.eventcategory',['action'=>'update','id'=>$item->id])}}"
                            class="sb2-2-1-edit"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a>
                    </td>
                    <td class="text-center" style="vertical-align:middle;">
                        <i href="{{  url('delete/event_category') }}/{{ $item->id }}"
...
function confirm_delete(id) {
    let c = confirm("Do you want to delete this Event Category ?");
    if (c === true) {
        window.location.href = "{{url('delete/event_category')}}/" + id;
    }
}
</script>
