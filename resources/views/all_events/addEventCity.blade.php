...
<div class="sb2-2">
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="active-bre"><a href="{{route('view.add.city',['action'=>'add'])}}"> <b>Add Event City</b> </a>
            </li>
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input id="" type="text" name="name" class="validate" @if($action=='add' ) @else
                                    value="{{ $Event_City->name ?? '' }}" @endif required="required" />
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea id="description" class="materialize-textarea" name="description"
                                    required="required">@if($action=='add') @else {{ $Event_City->description ?? '' }} @endif</textarea>
