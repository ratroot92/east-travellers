    ...
    <div class="rows inn-page-bg com-colo">
        <div class="container inn-page-con-bg tb-space">
            <div class="col-md-8 col-md-push">
                ...
                <!--====== TOUR DESCRIPTION ==========-->
                <div class="">
                    <h3><i class="fa fa-umbrella" style="background-color: darkorange;font-size: 20px"></i> Description
                    </h3>
                    <p>{{$activity->desc}}</p>
                </div>
                <!--====== ROOMS: HOTEL BOOKING ==========-->
                <div class="hotel-book-room">
                    ...
                    <div id="myCarousel1" class="carousel slide photo-gallery-slider" data-ride="carousel">
                        ...
                        <ol class="carousel-indicators carousel-indicators-1">
                            ...
                            <li data-target="#myCarousel1" data-slide-to="{{$key}}"><img src="{{$slider->src}}"
                                    alt="banner">
                            </li>
                            @endforeach
                        </ol>
                        ...
                        <div class="carousel-inner carousel-inner1" role="listbox">
                            @foreach($images as $key => $slider)
                            <div class="item  {{$key == 0 ? 'active' : '' }}"> <img src="{{$slider->src}}" alt="Chania"
                ...
                <!--   <div class="col-md-12">-->
                <!--      <a type="button" class="btn btn-danger btn-lg" style="border-radius: 0px;font-weight: bold;font-size:12px;"id="Btnpdf" href="{{URL::to('/event/downloadPDF/').'/'.$activity->id}}">Download As PDF</a>-->
                <!--   </div>-->
                <!--</div>-->
                <!--====== TOUR LOCATION ==========-->
                ...
                <div class="tour_right ">
                    ...
                    <div class="col-sm-6" style="padding: 1px;">
                        <a type="button" class="btn btn-danger btn-lg"
                            ...
                            href="{{URL::to('/event/downloadPDF/').'/'.$activity->id}}">Download PDF</a>
                    </div>
                </div>
