                            ...
                            <div class="hot-page2-alp-l-com1 hot-page2-alp-p4">
                                <form>
                                    <div id="cities">
                                        <ul class="">
                                            <li>
                                                <a href="{{route('all.events.daytour')}}" style="padding:0px!important;margin:0px!important;color:white; border:none;">
...
<script>
    function getCityNameForSearch(city) {
        console.log(city);
        window.location.href = "{{URL::to('search/daytour/city')}}" + "/" + city;
    }

    function getCountryNameForSearch(country) {
        console.log(country);
        window.location.href = "{{URL::to('search/daytour/country')}}" + "/" + country;
    }

    function getCategoryNameForSearch(category) {
        console.log(category);
        window.location.href = "{{URL::to('search/daytour/category')}}" + "/" + category;
    }
    ...
    function getPriceForSearch(price) {
        ...
        window.location.href = "{{URL::to('search/daytour/price')}}" + "/" + min + "/" + max;
    }
