        ...
        <div class="container-fluid">
                    ...
                    <div class="tour-mig-like-com">
                        ...
                        <div class="tour-mig-lc-con">
                            ...
                            <p><span>{{--12 Packages--}}</span>
                                {{$item[0]->country}}{{--{{substr($item[0][0]->description,0,50)}}--}}{{--Starting from $2400--}}
                            </p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="tour-mig-like-com">
                        <div class="tour-mig-lc-img">
                            <img src="{{$item[1]->banner}}" alt="" title="{{ $item[1]->description }}"
                        ...
                        <div class="tour-mig-lc-con tour-mig-lc-con2">
                            <h5>{{$item[1]->name}}</h5>
                            <p><span>{{--12 Packages--}}</span>
                                {{$item[1]->country}}{{--{{substr($item[0][0]->description,0,50)}}--}}{{--Starting from $2400--}}
                            </p>
                        </div>
                    </div>
                </a>
                ...
                <a href="">
                    <div class="tour-mig-like-com">
                        <div class="tour-mig-lc-img">
                            ...
                            <img src="{{$item[2]->banner}}" alt="" title="{{ $item[2]->description }}"
                                style="height: 150px;width: 100%;">
                        </div>
                        <div class="tour-mig-lc-con tour-mig-lc-con2">
                            <h5>{{$item[2]->name}}</h5>
                            <p><span>{{--12 Packages--}}</span>
                                {{$item[2]->country}}{{--{{substr($item[0][0]->description,0,50)}}--}}{{--Starting from $2400--}}
                            </p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="tour-mig-like-com">
                        <div class="tour-mig-lc-img">
                            <img src="{{$item[3]->banner}}" alt="" title="{{ $item[3]->description }}"
                                style="height: 150px;width: 100%;">
                            {{--<img src="{{url('/theme/travel')}}/images/listing/home3.jpg" alt="">--}}
                        </div>
                        <div class="tour-mig-lc-con tour-mig-lc-con2">
                            <h5>{{$item[3]->name}}</h5>
                            <p><span>{{--12 Packages--}}</span>
                                {{$item[3]->country}}{{--{{substr($item[0][0]->description,0,50)}}--}}{{--Starting from $2400--}}
                            </p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="tour-mig-like-com">
                        <div class="tour-mig-lc-img">
                            {{-- <img src="{{url('/theme/travel')}}/images/listing/home2.jpg" alt="">--}}
                            <img src="{{$item[4]->banner}}" alt="" title="{{ $item[4]->description }}"
                                style="height: 150px;width: 100%;">
                        </div>
                        <div class="tour-mig-lc-con tour-mig-lc-con2">
                            <h5>{{$item[4]->name}}</h5>
                            <p><span>{{--12 Packages--}}</span>
                                {{$item[4]->country}}{{--{{substr($item[0][0]->description,0,50)}}--}}{{--Starting from $2400--}}
                            </p>
                        </div>
                    </div>
                </a>
                ...
                <a href="">
                    <div class="tour-mig-like-com">
                        ...
                        <div class="tour-mig-lc-con">
                            <h5>{{$item[6]->name}}</h5>
                            <p><span>{{--12 Packages--}}</span>
                                {{$item[6]->country}}{{--{{substr($item[0][0]->description,0,50)}}--}}{{--Starting from $2400--}}
                            </p>
                        </div>
                    </div>
                </a>
                ...
                <a href="">
                    <div class="tour-mig-like-com">
                        ...
                        <div class="tour-mig-lc-con">
                            <h5>{{$item[7]->name}}</h5>
                            <p><span>{{--12 Packages--}}</span>
                                {{$item[7]->country}}{{--{{substr($item[0][0]->description,0,50)}}--}}{{--Starting from $2400--}}
                            </p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="tour-mig-like-com">
                        <div class="tour-mig-lc-img">
                            <img src="{{$item[7]->banner}}" alt="" title="{{ $item[0]->description }}"
                                style="height: 150px;width: 100%;">
                            {{--<img src="{{url('/theme/travel')}}/images/listing/home3.jpg" alt="">--}}
                        </div>
                        <div class="tour-mig-lc-con tour-mig-lc-con2">
                ...
                <a href="">
                    <div class="tour-mig-like-com">
                        ...
                        <div class="tour-mig-lc-con tour-mig-lc-con2">
                            <h5>{{$item[8]->name}}</h5>
                            <p><span>{{--12 Packages--}}</span>
                                {{$item[8]->country}}{{--{{substr($item[0][0]->description,0,50)}}--}}{{--Starting from $2400--}}
                            </p>
                        </div>
                    </div>
                </a>
                ...
                <a href="">
                    <div class="tour-mig-like-com">
                        ...
                        <div class="tour-mig-lc-con tour-mig-lc-con2">
                            <h5>{{$item[9]->name}}</h5>
                            <p><span>{{--12 Packages--}}</span>
                                {{$item[9]->country}}{{--{{substr($item[0][0]->description,0,50)}}--}}{{--Starting from $2400--}}
                            </p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="tour-mig-like-com">
                        <div class="tour-mig-lc-img">
                            {{-- <img src="{{url('/theme/travel')}}/images/listing/home2.jpg" alt="">--}}
                            <img src="{{$item[5]->banner}}" alt="" title="{{ $item[0]->description }}"
                                style="height: 150px;width: 100%;">
                        </div>
                        <div class="tour-mig-lc-con tour-mig-lc-con2">
                            <h5>{{$item[5]->name}}</h5>
                            <p><span>{{--12 Packages--}}</span>
                                {{$item[5]->country}}{{--{{substr($item[0][0]->description,0,50)}}--}}{{--Starting from $2400--}}
                            </p>
                        </div>
                    </div>
                </a>
